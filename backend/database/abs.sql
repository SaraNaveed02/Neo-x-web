-- ============================================================
-- NEXURA / NEOXWEB — COMPLETE DATABASE
-- File: backend/database/abs.sql
--
-- Import: phpMyAdmin → Import → abs.sql
--     OR: http://localhost/time/backend/install.php
--
-- Default Admin:
--   Username : admin
--   Email    : admin@example.com
--   Password : admin123  (stored as bcrypt hash — NOT plain text)
-- ============================================================
...
-- ============================================================
-- 1. USERS (Email + Social OAuth + Admin)
...
-- ============================================================
-- 2. USER SESSIONS (secure session tracking)
-- ============================================================
...
-- ============================================================
-- 3. CONTACT MESSAGES (website contact form)
-- ============================================================
...
-- ============================================================
-- 7. SITE STATS (public website counters)
-- ============================================================
...
-- ============================================================
-- 8. DASHBOARD STATS (admin panel counters)
-- ============================================================
...
-- ============================================================
-- 10. APP SETTINGS (OAuth keys + site config)
-- ============================================================
...
-- ============================================================
-- 11. MICROSOFT 365 OAUTH (encrypted tokens)
-- ============================================================
...
-- ============================================================
-- 12. MICROSOFT MAIL MESSAGES (synced inbox)
-- ============================================================
...
('social_linkedin', 'https://linkedin.com/company/neoxweb', 'social'),
('social_twitter', 'https://twitter.com/neoxweb', 'social'),
...
('Artificial Intelligence', 'AI solutions and automation', 'fa-robot', 'ai', 1);

-- Site stats (homepage / about / login pages)
...
('login_products', '0', 'Products launched', 'login', 1, 1, 'services_count'),
('login_retention', '0', 'Client retention', 'login', 2, 1, 'client_retention'),
('login_support', '24/7', 'Support coverage', 'login', 3, 0, NULL),
('about_clients', '0', 'Registered clients', 'about', 1, 1, 'clients_count'),
('about_retention', '0', 'Client retention rate', 'about', 2, 1, 'client_retention'),
('about_services', '0', 'Active services', 'about', 3, 1, 'services_count'),
...
('global_support', '24/7', 'Support available', 'global', 4, 1, 'support_coverage');

-- ============================================================
-- DONE
-- ============================================================
SELECT 'OK — Database ready. Admin: admin / admin123 (bcrypt stored)' AS result;
